...
constants.max_visible_squirrels_per_region = 3
...
constants.squirrel_home_wander_distance = 10
constants.squirrel_transport_line_scan_limit = 8
constants.squirrel_move_timeout = 60 * 8
constants.squirrel_decision_interval = 60 * 4
