...
constants.squirrel_flee_repath_interval = 8
constants.squirrel_flee_step_distance = 3.5
constants.squirrel_flee_goal_distance = constants.chunk_size
constants.squirrel_flee_min_distance_from_player = constants.chunk_size / 2
constants.squirrel_flee_stuck_ticks = 8
constants.squirrel_flee_progress_distance = 0.2
constants.squirrel_flee_min_step_distance = 0.9
