...
constants.survey_cluster_search_radius = 3
...
constants.squirrel_idle_pause_min = 45
constants.squirrel_idle_pause_max = 105
...
constants.squirrel_calm_local_target_radius = 6
constants.squirrel_curious_local_target_radius = 6
constants.squirrel_mischievous_local_target_radius = 8
constants.squirrel_agitated_local_target_radius = 10
constants.squirrel_grieving_local_target_radius = 12
...
constants.squirrel_belt_inspect_duration = 60 * 4
