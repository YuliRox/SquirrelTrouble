...
describe("milestone 0 scaffold", function()
  ...
  it("gives squirrels a readable clickable footprint", function()
    ...
    assert.is_true((moving.collision_box.right_bottom.x - moving.collision_box.left_top.x) > 0)
    assert.is_true((moving.collision_box.right_bottom.x - moving.collision_box.left_top.x) < (moving.selection_box.right_bottom.x - moving.selection_box.left_top.x))
    assert.equal(moving.selection_box.left_top.x, -moving.selection_box.right_bottom.x)
  end)
